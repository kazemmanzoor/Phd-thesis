...
for i in 5 10 15 20 25 30 35 40 45 50 55 60 65 70; do cd $i"na"/source; more $allotrop-top.txt | awk -v i="$i" -v numberofwater="$numberofwater" -v numberofions="$numberofions" -v numberofphosphorene="$numberofphosphorene" '{print "\t" $1-9980+1+numberofphosphorene+ 3*(numberofwater-i)+numberofions+(numberofions+i)"\t" (numberofwater-i)+numberofions+(numberofions+i)+2 "\t"6"\t"0"\t" $5 "\t"$6"\t"$7 }' > $allotrop-modify-top.txt  ; cd ../.. ; done

for i in 5 10 15 20 25 30 35 40 45 50 55 60 65 70; do cd $i"na"/source ;cat $allotrop-modify-bottom.txt $allotrop-modify-top.txt > ../$allotrop-channel.txt; cd ../.. ; done

echo "#############################EEEEEEXXXX#####################"

for i in 5 10 15 20 25 30 35 40 45 50 55 60 65 70; do cat > $i"na"/$i"na"-Ex/$allotrop-$i"na-Ex.in" << EOF  #cat << 'EOF' > $i"na"/mixture-$i"na".in
...
for i in 5 10 15 20 25 30 35 40 45 50 55 60 65 70; do cat > $i"na"/$i"na"-Ey/$allotrop-$i"na-Ey.in" << EOF  #cat << 'EOF' > $i"na"/mixture-$i"na".in
